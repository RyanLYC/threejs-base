...
import basicVertexShader from '../shader/wave/vertex.glsl?raw'
import basicFragmentShader from '../shader/wave/fragment.glsl?raw'
...
const texture = textureLoader.load('./images/art.jpg')
